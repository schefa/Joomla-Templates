...
<body>
    ...
    <div class="offcanvas">
        ...
        <div class="col-sm-3 offcanvas-smartphones sidebar-offcanvas offcanvas-right visible-xs">
            <?php echo $doc->getBuffer('modules', 'mainmenu', array('style' => 'apas_sidebar')); ?>
            <?php echo $doc->getBuffer('modules', 'submenu', array('style' => 'apas_sidebar')); ?>
        </div>
        ...
        <div class="apas-header">
            <div class="container">
        		...
        		<?php if($doc->getBuffer('modules', 'search', array('style' => 'none'))) { ?>
                    <div class="apas-search"><?php echo $doc->getBuffer('modules', 'search', array('style' => 'none')); ?></div>
                <?php } ?>
                </div>
            </div>
        </div>
